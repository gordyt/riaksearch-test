...
class Agent(threading.Thread):
    ...
    def run(self):
        ...
        # 2011-06-06 (got) - added support for setup code
        if hasattr(trans, 'setUp') and callable(trans.setUp):
            trans.setUp()
        ...
        # 2010-10-08 (got) - added support for cleanup code
        if hasattr(trans, 'tearDown') and callable(trans.tearDown):
            trans.tearDown()
